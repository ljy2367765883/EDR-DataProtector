  ...
  dataprotector: {
    ...
    policy: {
      ...
      userhook: {
        ...
        enforcement: 'Early protection switch',
        enforcementDesc: 'Kernel early-bird awareness tracks process startup and hook-sensitive module loading before the signed runtime takes over.',
        earlyProcess: 'Early process monitor',
        earlyProcessDesc: 'Records process creation at the kernel notification stage for runtime protection decisions.',
        imageLoad: 'Hook surface image monitor',
        imageLoadDesc: 'Tracks ntdll, kernelbase, wininet, ws2_32, amsi and other hook-sensitive images.',
        ...
        surfacesList: {
          ...
          earlyDetail: 'Creates auditable protection records before user code begins normal execution.',
