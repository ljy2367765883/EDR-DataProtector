const local: App.I18n.Schema = {
  ...
  dataprotector: {
    ...
    sandbox: {
      ...
      logsCleared: 'Sandbox logs cleared.',
      ...
      clearLogsTitle: 'Clear sandbox logs',
      clearLogsContent: 'Clear all sandbox run directories and page reports? Sample files stay available for another analysis.',
      arguments: 'Arguments',
      argumentsPlaceholder: 'Optional arguments',
      timeout: 'Analysis time (seconds)',
      options: 'Isolation options',
