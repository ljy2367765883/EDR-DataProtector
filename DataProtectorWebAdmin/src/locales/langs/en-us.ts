const local: App.I18n.Schema = {
  ...
  dataprotector: {
    ...
    policy: {
      ...
      userhook: {
        title: 'Application Hook Defense Policy',
        enforcement: 'Early injection protection',
        enforcementDesc: 'Kernel early-bird control selects non-whitelisted suspicious processes for the user-mode hook runtime.',
        earlyProcess: 'Inject non-whitelisted processes',
        earlyProcessDesc: 'Whitelist entries are excluded from injection; other processes can load the hook runtime early for behavior monitoring.',
        imageLoad: 'Hook surface image monitor',
        imageLoadDesc: 'Tracks hook-sensitive images only inside processes selected for runtime injection.',
        ...
        active: 'Active: {count}',
        excludedProcesses: 'Do-not-inject process names',
        excludedProcessPlaceholder: 'One process per line, for example chrome.exe',
        excludedDirectories: 'Do-not-inject process directories',
        ...
        save: 'Save App Hook Defense',
        surfaces: 'Protected Application Hook Surfaces',
        saved: 'Application hook defense policy saved to central policy.',
        surfacesList: {
          earlyTitle: 'Kernel early-bird process stage',
          earlyDetail: 'Requests hook runtime injection only for processes outside the whitelist.',
          imageTitle: 'Sensitive API module loading',
          imageDetail: 'Observes common API hook targets used for network, credential, UI and script interception.',
