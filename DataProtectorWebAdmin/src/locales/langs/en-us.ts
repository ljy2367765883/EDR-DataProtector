const local: App.I18n.Schema = {
  ...
  dataprotector: {
    ...
    sandbox: {
      ...
      logsDeleted: 'Sandbox logs deleted.',
      logsCleared: 'Sandbox history cleared.',
      ...
      deleteLogsTitle: 'Delete sandbox logs',
      deleteLogsContent: 'Delete only the sandbox report and server run logs for {name}? The sample file stays available for another analysis.',
      clearLogsTitle: 'Clear sandbox history',
      clearLogsContent: 'Clear all sandbox run directories, page reports, sample records, and server-side sample files? The queue will be empty afterward.',
      arguments: 'Arguments',
      argumentsPlaceholder: 'Optional arguments',
      timeout: 'Analysis time (seconds)',
      options: 'Isolation options',
      ...
      attackFlow: {
        ...
        detailsPanel: {
          ...
          entityDescription: '{count} record(s) of this entity type appeared in this sandbox analysis.',
          category: 'Category',
          stage: 'Attack Stage',
          processTab: 'Process',
          fileTab: 'File',
          ...
          blocked: 'Blocked',
          observed: 'Observed',
          behaviorSource: 'Behavior Rule',
          runtimeSource: 'Runtime Hook',
          kernelSource: 'Kernel Sensor',
          networkSource: 'Network Telemetry',
          fileSource: 'File Telemetry',
          serviceSource: 'Service Telemetry',
          taskSource: 'Scheduled Task',
          processSource: 'Process Telemetry',
