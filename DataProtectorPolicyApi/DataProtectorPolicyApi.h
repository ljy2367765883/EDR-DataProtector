...
#define DP_POLICY_API_USER_HOOK_OPERATION_PROCESS_CREATE           1u
#define DP_POLICY_API_USER_HOOK_OPERATION_HOOK_SURFACE_IMAGE_LOAD  2u
#define DP_POLICY_API_USER_HOOK_OPERATION_RUNTIME_REQUIRED         3u
#define DP_POLICY_API_USER_HOOK_OPERATION_RUNTIME_MISSING          4u
#define DP_POLICY_API_USER_HOOK_OPERATION_RUNTIME_REJECTED         5u
#define DP_POLICY_API_USER_HOOK_OPERATION_SUSPICIOUS_HOOK_ATTEMPT  6u
#define DP_POLICY_API_USER_HOOK_OPERATION_RUNTIME_INJECTION_REQUIRED 7u
#define DP_POLICY_API_USER_HOOK_OPERATION_RUNTIME_INJECTION_QUEUED 8u
#define DP_POLICY_API_USER_HOOK_OPERATION_RUNTIME_INJECTION_FAILED 9u
#define DP_POLICY_API_USER_HOOK_OPERATION_RUNTIME_INJECTION_SKIPPED 10u
#define DP_POLICY_API_USER_HOOK_OPERATION_BEHAVIOR_PROCESS_ACCESS 11u
#define DP_POLICY_API_USER_HOOK_OPERATION_BEHAVIOR_THREAD_ACCESS 12u
#define DP_POLICY_API_USER_HOOK_OPERATION_SENSITIVE_IMAGE_RELOAD 13u
#define DP_POLICY_API_USER_HOOK_OPERATION_SENSITIVE_IMAGE_ABNORMAL_PATH 14u
#define DP_POLICY_API_USER_HOOK_OPERATION_BEHAVIOR_REMOTE_THREAD_CREATE 15u

#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_ENABLED                  0x00000001u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_EARLY_PROCESS_INJECTION  0x00000002u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_EARLY_PROCESS_MONITOR    DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_EARLY_PROCESS_INJECTION
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_IMAGE_LOAD_MONITOR       0x00000004u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_REQUIRE_SIGNED_RUNTIME   0x00000008u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_BLOCK_UNTRUSTED_RUNTIME  0x00000010u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_AUDIT_ONLY               0x00000020u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_MONITOR_SYSTEM_PROCESSES 0x00000040u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_RUNTIME_API_BEHAVIOR     0x00000080u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_RUNTIME_MEMORY_SCAN      0x00000100u
#define DP_POLICY_API_USER_HOOK_DEFENSE_FLAG_ETW_TAMPER_MONITOR       0x00000200u
...
typedef struct _DP_POLICY_API_USER_HOOK_DEFENSE_EVENT {
    ULONGLONG Sequence;
    ULONGLONG ProcessId;
    ...
    LPCWSTR Target;
    LPCWSTR ProcessImage;
} DP_POLICY_API_USER_HOOK_DEFENSE_EVENT, *PDP_POLICY_API_USER_HOOK_DEFENSE_EVENT;

typedef struct _DP_POLICY_API_USER_HOOK_DEFENSE_POLICY {
    DWORD Flags;
